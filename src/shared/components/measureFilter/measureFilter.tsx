...
// проброс спутников извне и диапазонов тоже
...
const MeasureFilter: FC<MeasureFilterProps> = ({ filters, setFilters }) => {
  ...
  return (
    <>
      ...
      >
        <FormLabel sx={{ margin: '20px 0' }} component='legend'>
          Тип спутниковой группировки:
        </FormLabel>
        <FormGroup>
          <FormControlLabel
            control={
        ...
        <Typography variant='body1' color='initial'>
          Время поиска записи с {filters.timeRange[0]} часов по{' '}
          {filters.timeRange[1]} часов
        </Typography>
      </FormControl>
    </>
  )
