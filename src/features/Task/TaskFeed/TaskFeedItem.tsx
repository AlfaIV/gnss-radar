...
const TaskFeedItem = memo(
  forwardRef<HTMLDivElement, TaskFeedItemProps>((props, ref) => {
    const {
      id,
      name,
      description,
          ...
          <Box sx={{ padding: 5 }}>
            <Stack spacing={2}>
              ...
              >
                ...
                <Chip
                  label={
                    dayjs().isAfter(datetimeEnd) ? 'Завершено' : 'В процессе'
                  }
                  sx={{
            ...
            >
              ...
              {isAll && (
                <Chip label='Все спутники в заданном временном диапазоне' />
              )}
            </Stack>
            <Divider />
            <Box
            ...
            >
              <Button variant='contained' onClick={() => setIsOpenUpdate(true)}>
                Обновить
              </Button>
              <Button
                color='error'
